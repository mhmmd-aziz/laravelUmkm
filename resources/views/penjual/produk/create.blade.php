                ...
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('penjual.produk.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="harga" class="block mt-1 w-full" type="number" name="harga" :value="old('harga')" required placeholder="Contoh: 150000" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="berat_gram" class="block mt-1 w-full" type="number" name="berat_gram" :value="old('berat_gram', 1000)" required placeholder="Contoh: 1500" />
                        ...
                        <!-- Gambar Produk Utama -->
                        <div class="mt-4">
                            <x-input-label for="gambar_produk_utama" :value="__('Gambar Produk Utama')" />
                            <input id="gambar_produk_utama" name="gambar_produk_utama" type="file" class="block mt-1 w-full text-sm text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-700 rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 focus:outline-none" required>
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Format: JPG, PNG, WEBP. Maks: 2MB.</p>
